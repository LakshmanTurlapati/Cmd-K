...
Plans:
- [ ] 04-01-PLAN.md -- Rust backend: stream_ai_response command with SSE streaming, eventsource-stream, two-mode system prompts, Tauri IPC Channel
...
| 4. AI Command Generation | 0/3 | Not started | - |

...
- [ ] **PROC-02**: Internal IDE cmd.exe processes (git, extensions, tasks) filtered out — only interactive console-attached cmd.exe selected
- [ ] **PROC-03**: Process snapshot consolidated into single CreateToolhelp32Snapshot call shared across shell discovery, WSL detection, and diagnostics
